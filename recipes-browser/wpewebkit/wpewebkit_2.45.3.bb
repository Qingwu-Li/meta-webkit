...
SRC_URI = "https://wpewebkit.org/releases/${BPN}-${PV}.tar.xz;name=tarball \
           file://0004-simde-arm-fix-gcc11-build-excess-elements-failure.patch \
          "
...
#2.45.x is not a stable WPE release. Odd-numbered versions refer to development releases.
